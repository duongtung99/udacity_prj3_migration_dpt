...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="admindpt@prj3-postgress-dpt", password="Dpt.15112023", host="prj3-postgress-dpt.postgres.database.azure.com")
